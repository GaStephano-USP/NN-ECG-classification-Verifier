...
def evaluate_saved_model(model_path="./BreastMNISTFC.pth", batch_size=128):
    # 1. Set up device
    ...
    print("Loading BreastMNIST test dataset...")
    test_dataset = BreastMNIST(split='train', transform=transform, download=True)
