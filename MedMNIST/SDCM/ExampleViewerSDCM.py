...
for i in range(129):
    ...
    caminho_arquivo = f'safety_benchmarks/benchmarks/BreastMNIST/vnnlib/Property_{i}.vnnlib'
    ...
    imagem.save(f'example_images/BreastMNIST/imagem_reconstruida_original_{i}.png')