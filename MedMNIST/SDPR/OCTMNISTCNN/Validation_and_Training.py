...
from model_max_3 import OCTMNISTCNN
...
for epoch in range(num_epochs):
    ...
    for inputs, labels in train_loader:
        ...
        preds = torch.argmax(outputs, dim=1) # threshold at 0.5
    ...
    if epoch % check_val_every_n_epoch == 0:
        with torch.no_grad():
            ...
            for inputs, labels in val_loader:
                ...
                preds_v = torch.argmax(outputs, dim=1)
...
fig.savefig("MedMNIST/SDPR/OCTMNISTCNN/grafico3_max.png")
model.eval()
...
torch.save(model.state_dict(), "./trained_models/OCT_ConvNet/OCTMNISTCNN3_Max.pth")  # Save the model state