...
from model_max_4 import OCTMNISTCNN
...
fig.savefig("MedMNIST/SDPR/OCTMNISTCNN/grafico4_max.png")
model.eval()
...
torch.save(model.state_dict(), "./trained_models/OCT_ConvNet/OCTMNISTCNN4_Max.pth")  # Save the model state