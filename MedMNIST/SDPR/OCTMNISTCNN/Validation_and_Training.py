...
from model_max_1 import OCTMNISTCNN
...
fig.savefig("MedMNIST/SDPR/OCTMNISTCNN/grafico1_max.png")
model.eval()
...
torch.save(model.state_dict(), "./trained_models/OCT_ConvNet/OCTMNISTCNN1_Max.pth")  # Save the model state