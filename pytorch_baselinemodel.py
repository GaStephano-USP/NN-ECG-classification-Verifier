...
class ResidualBlock1D(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=5):
        ...
        self.relu2 = nn.ReLU()
        self.shortcut = nn.Conv1d(in_channels, out_channels, kernel_size, stride=1, padding=kernel_size//2)
...
class ResNet1D(nn.Module):
    def __init__(self, num_classes=5):
        ...
        self.resblock2 = ResidualBlock1D(in_channels=32, out_channels=32)
        self.pool2 = nn.MaxPool1d(kernel_size=kernel_size, stride=2, padding=0)
        
        self.resblock3 = ResidualBlock1D(in_channels=32, out_channels=64)
        self.pool3 = nn.MaxPool1d(kernel_size=kernel_size, stride=2, padding=0)
        
        self.resblock4 = ResidualBlock1D(in_channels=64, out_channels=64)
        self.pool4 = nn.MaxPool1d(kernel_size=kernel_size, stride=2, padding=0)
        
        self.resblock5 = ResidualBlock1D(in_channels=64, out_channels=128)
        self.pool5 = nn.MaxPool1d(kernel_size=kernel_size, stride=2, padding=0)
