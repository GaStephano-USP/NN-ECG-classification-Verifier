...
class ResNet2D(nn.Module):
    def __init__(self, num_classes=5):
        ...
        self.pool1 = nn.MaxPool2d(kernel_size=(kernel_size, 1), stride=(2, 1), padding=(0, 0))
        
        self.resblock2 = ResidualBlock2D(in_channels=32, out_channels=32)
        self.pool2 = nn.MaxPool2d(kernel_size=(kernel_size, 1), stride=(2, 1), padding=(0, 0))
        
        self.resblock3 = ResidualBlock2D(in_channels=32, out_channels=64)
        self.pool3 = nn.MaxPool2d(kernel_size=(kernel_size, 1), stride=(2, 1), padding=(0, 0))
        
        self.resblock4 = ResidualBlock2D(in_channels=64, out_channels=64)
        self.pool4 = nn.MaxPool2d(kernel_size=(kernel_size, 1), stride=(2, 1), padding=(0, 0))
        
        self.resblock5 = ResidualBlock2D(in_channels=64, out_channels=128)
        self.pool5 = nn.MaxPool2d(kernel_size=(kernel_size, 1), stride=(2, 1), padding=(0, 0))
